varying vec2 vUv;
varying vec3 vUv3; // Receive the vec3 value from the vertex shader
...
void main() {
    ...
    float perlinNoise = cnoise(vUv3 * uNoiseScale) * sinloop * amplitude;
    ...
    vec3 mixColor = mix(blackColor, mix1, (vStrength) * 3.0);
